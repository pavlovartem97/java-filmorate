...
public class UserService {
    ...
    public void addFriend(int id, int friendId) {
        ...
        log.info("Put friend {} for user {}", friendId, id);
    }
    ...
    public void removeFriend(int id, int friendId) {
        ...
        log.info("Delete friend {} for user {}", friendId, id);
    }
    ...
    public Collection<Film> getRecommendations(int id) {
        ...
        log.info("Got {} recommended films", recommendationFilms.size());
    ...
    public Collection<Feed> getFeed(int id) {
        ...
        log.info("Got {} feeds objects", feed.size());
        return feed;
    }
    ...
    private void checkUsers(int userId1, int userId2) {
        if (!userStorage.contains(userId1)) {
            throw new UserNotFoundException(String.format("User is not found %d", userId1));
        }
        if (!userStorage.contains(userId2)) {
            throw new UserNotFoundException(String.format("User is not found %d", userId2));
        }
    }
